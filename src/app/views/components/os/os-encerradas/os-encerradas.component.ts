...
@Component({
  selector: 'app-os-encerradas',
  templateUrl: './os-encerradas.component.html',
  styleUrls: ['./os-encerradas.component.css']
})
export class OsEncerradasComponent implements AfterViewInit {

  os : Os[] = []

  displayedColumns: string[] = ['tecnico', 'cliente', 'status','prioridade','dataAbertura' , 'dataFechamento' , 'actions'];
